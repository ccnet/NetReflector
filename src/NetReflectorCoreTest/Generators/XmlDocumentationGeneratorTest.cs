...
using NetReflectorCore.Generators;
using NetReflectorCore.Util;
using NUnit.Framework;

namespace NetReflectorCoreTest.Generators
{
	[TestFixture]
	public class XmlDocumentationGeneratorTest
	{
		...
		public void ShouldProduceXmlDocumentationOfReflectorTypes()
		{
			...
			string expectedXml = @"<?xml version=""1.0"" encoding=""utf-16""?><netreflector><reflectortype><name>TestClass</name><namespace>NetReflectorCoreTest</namespace><reflectorName>reflectTest</reflectorName>" +
		...
		public void ShouldProduceXmlDocumentationOfReflectorTypesButNotIncludeEmptyDescriptions()
		{
			...
			string expectedXml = @"<?xml version=""1.0"" encoding=""utf-16""?><netreflector><reflectortype><name>TestSubClass</name><namespace>NetReflectorCoreTest</namespace><reflectorName>sub</reflectorName></reflectortype></netreflector>";
			Assert.AreEqual(expectedXml, writer.ToString());
		}
